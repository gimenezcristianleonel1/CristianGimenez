...
potrero **lista los animales que contiene**, permite **dar de alta un animal directamente
ahí** (queda asignado a ese potrero) y ofrece **acciones masivas**: mover a todos a otro
potrero, o aplicar un **evento sanitario masivo** (ej. desparasitación) a todo el lote —
cada acción se encola por animal y se sincroniza sola.
